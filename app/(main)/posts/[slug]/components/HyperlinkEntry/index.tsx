...
export default async function HyperlinkEntry({
  ...
  return (
    <Link
      ...
      className="my-2 flex cursor-pointer flex-col gap-2 rounded-lg border bg-gray-100 p-4 no-underline shadow-none duration-300 ease-in-out hover:border-transparent hover:bg-white hover:shadow-lg prose-headings:mb-1 prose-headings:mt-0 prose-p:mb-2"
    >
